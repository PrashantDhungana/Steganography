       ...
       <div class="row">
        <div class="card-deck mt-3">
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">This is a longer card with supporting te We would like to express our grati tude.</p>
           <div class="icons">
          ...
          <div class="card">
            <img class="card-img-top" src="img/img2 (6).jpg" alt="Card image cap">
            <div class="card-body">
              <p class="card-text">This card has supporting text below t We would like to express our grati tude.</p>
              <div class="icons">
                <a href=""><i class="fa fa-bookmark" aria-hidden="true"></i></a>
                <a href=""><i class="fa fa-eye" aria-hidden="true"></i></a>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">We would like to express our grati tude for giving us an oppo rtunity to offer our </p>
              <div class="icons">
                <a href=""><i class="fa fa-bookmark" aria-hidden="true"></i></a>
                <a href=""><i class="fa fa-eye" aria-hidden="true"></i></a>
          ...
          <div class="card">
            <img class="card-img-top" src="img/img2 (5).jpg" alt="Card image cap">
            <div class="card-body">
              <p class="card-text">This is  as a natural  lead-in to additionalven longer content than the first to show .</p>
              <div class="icons m-0">
                <a href=""><i class="fa fa-bookmark" aria-hidden="true"></i></a>
                <a href=""><i class="fa fa-eye" aria-hidden="true"></i></a>
